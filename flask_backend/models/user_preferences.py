...
class UserPreferences(BaseModel):
    ...
    custom_preferences = db.Column(db.JSON)  # Additional user preferences

    def __init__(self, **kwargs):
        """Initialize user preferences model."""
    ...
    def update_display_settings(
        ...
        """Update display-related preferences."""
    ...
    def update_calendar_settings(
        ...
        """Update calendar-related preferences."""
    ...
    def update_custom_preference(self, key: str, value: Any) -> None:
        """Update a custom preference."""
        self.custom_preferences[key] = value
        self.save()

    def remove_custom_preference(self, key: str) -> None:
    ...
    @classmethod
    def get_by_user(cls, user_id: int) -> Optional['UserPreferences']:
        """Get preferences by user ID."""
        return cls.query.filter_by(user_id=user_id).first()

    @classmethod
    def create_default_preferences(cls, user_id: int) -> 'UserPreferences':
    ...
    def to_dict(self) -> dict:
        ...
        data['custom_preferences'] = self.custom_preferences
        return data 